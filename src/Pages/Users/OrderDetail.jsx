  ...
  //    fetchOrder(orderId);
    ...
    const generatePDF = () => {
      ...
      doc.autoTable({
        startY: currentY,
        head: [['Name', 'Email']],
        body: [[`${order.user.firstName} ${order.user.lastName}`, order.user.email]],
        theme: 'plain',
        styles: { fillColor: [255, 255, 255], textColor: [0, 0, 0]}
      });
      ...
      doc.autoTable({
        startY: currentY,
        head: [['Product Name', 'Quantity', 'Total Price in (Rupees)']],
        body: orderItems,
        theme: 'grid'
      });
      ...
      // Total Amount
      currentY += 10;
      addText(`Total Order Amount in (Rupees) : ${order.orderAmount.toFixed(2)}`, 10, currentY);
              ...
              <Col md={6}>
                ...
                <Row className="mb-3">
                  <Col>
                    ...
                    {order.reason ?  <h6>Comments: {order.reason}</h6> : ""}
                    ...
                    <Row key={index} className="mb-3">
                      ...
                      >
                        ...
                        > */}
                          ...
                          // width="100%"
                          // height="undefined"
                          style={{width: "60%", aspectRatio: "1", objectFit: "cover", borderRadius: "50%" }}
