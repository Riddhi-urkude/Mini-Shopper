...
export const CategoryProductsPage = () => {
  ...
  document.title = `MINI-SHOPPER | ${category?.categoryTitle}`;
  ...
  const fetchCategoryById = async (categoryId) => {
    try {
     ...
     // console.log("in category product page Category By Id");
      //console.log(data);
      setCategory(data);
    } catch (err) {
  ...
  const fetchProductsByCategoryId = async (categoryId, currentPage = 0) => {
    try {
      if (currentPage === 0) {
       ...
       // console.log("in category product page Products By CategoryId");
        //console.log(data);
        setProducts(data);
